...
export default async function ReturnsPage({
  ...
  const RETURN_STEPS = [
    { step: t("step1Step"), title: t("step1Title"), body: t("step1Body") },
    { step: t("step2Step"), title: t("step2Title"), body: t("step2Body") },
    { step: t("step3Step"), title: t("step3Title"), body: t("step3Body") },
    { step: t("step4Step"), title: t("step4Title"), body: t("step4Body") },
  ];
    ...
    <>
      ...
      <section className="bg-ivory section-padding-sm">
        <div className="container-luxury max-w-2xl mx-auto">
          <ScrollReveal>
            <h2 className="font-serif font-light text-brown mb-4" style={{ fontSize: "clamp(1.3rem, 2vw, 1.6rem)" }}>
              {t("howToReturnTitle")}
            </h2>
          </ScrollReveal>
