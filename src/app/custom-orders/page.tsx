...
export const metadata: Metadata = {
  title: "Custom Orders | Aura Stor",
  description:
    "Create a custom crystal jewelry piece at Aura Stor. Custom stone combinations, personalized gift sets, and bespoke designs — all via WhatsApp.",
};
...
const STEPS = [
  {
    ...
    body: "Send us a WhatsApp message describing what you have in mind — which stone or energy you are drawn to, the type of piece (bracelet, ring, necklace, set), and who it is for. There are no wrong answers.",
  },
  {
    number: "02",
...
export default function CustomOrdersPage() {
  const waMessage =
    "Hello! I'm interested in a custom crystal piece from Aura Stor. I'd love to discuss what's possible.";
  ...
  return (
    <>
      <PageHeader
        label="Bespoke"
        title="Custom Orders"
        subtitle="Every piece we make is personal. A custom order is just even more so."
        bg="ivory"
      />
        ...
        <div className="container-luxury max-w-xl mx-auto text-center">
          <ScrollReveal>
            <p className="font-sans text-sm text-brown/60 leading-loose">
              Our standard collection is thoughtfully curated, but we know that the perfect
              piece is sometimes one that does not exist yet. If you have a specific stone
              in mind, a combination you want to try, or a gift that needs to feel
              completely personal — that is exactly what custom orders are for.
            </p>
            <p className="font-sans text-sm text-brown/55 leading-loose mt-4">
              Every custom order is handled personally via WhatsApp from your first
              message to delivery. There is no form to fill out. Just a conversation.
            </p>
          </ScrollReveal>
        </div>
      </section>
            ...
            <StaggerReveal stagger={100}>
              {STEPS.map((step) => (
                <div key={step.number}
                  ...
                  <p className="font-serif text-4xl text-gold/25 font-light mb-4 leading-none">
                    {step.number}
                  </p>
        ...
        <div className="container-luxury max-w-xl mx-auto">
          <ScrollReveal>
            ...
            <p className="font-sans text-xs text-brown/40 mt-5 italic">
              If you can imagine it, we will do our best to make it for you.
            </p>
          </ScrollReveal>
        </div>
      </section>
        ...
        <div className="container-luxury text-center">
          <ScrollReveal>
            ...
            <p className="font-sans text-sm text-brown/55 mb-7 max-w-sm mx-auto leading-relaxed">
              Send us a WhatsApp message and let&rsquo;s talk about what you have in mind.
            ...
            <p className="font-sans text-xs text-brown/35 mt-3">
              We reply within a few hours &bull; Mon &ndash; Sun, 9 AM &ndash; 10 PM (GMT+3)
            </p>
          </ScrollReveal>
        </div>
      </section>
