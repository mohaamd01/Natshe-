...
export async function generateMetadata({
  ...
  return {
    ...
    description: `${collection.description} Shop the ${collection.name} collection at Aura Stor — handcrafted natural crystal jewelry shipped to Saudi Arabia, UAE, and Qatar.`,
    openGraph: {
      title: `${collection.name} Collection | Aura Stor`,
      description: collection.description,
      images: [{ url: collection.heroImage, alt: `${collection.name} collection` }],
    },
  };
}
    ...
    <>
      ...
      <div className="relative w-full pt-[120px] lg:pt-[100px]" style={{ minHeight: "55vh" }}>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 py-16 md:py-20 min-h-[55vh]">
          <p className="font-sans text-[11px] tracking-[0.35em] uppercase text-gold/80 mb-4">
            {collection.stoneName} Collection
          </p>
          <h1
            className="font-serif font-light text-ivory leading-tight mb-4"
            style={{ fontSize: "clamp(2.2rem, 6vw, 4rem)" }}
          >
            {collection.name}
          </h1>
          <p className="font-serif italic text-ivory/60 text-xl font-light mb-8 max-w-lg">
      ...
      <section className="bg-ivory section-padding-sm">
        <div className="container-luxury max-w-2xl mx-auto text-center">
          <ScrollReveal>
            ...
            <p className="font-sans text-sm text-brown/65 leading-loose">
              {collection.description}
            </p>
          </ScrollReveal>
        </div>
        ...
        <div className="container-luxury">
          <ScrollReveal>
            <div className="flex items-end justify-between mb-10">
              <div>
                <p className="font-sans text-[11px] tracking-[0.25em] uppercase text-brown/35 mb-2">
                  The Pieces
                </p>
                <h2
              ...
              <Link
                href="/shop"
                className="font-sans text-xs text-brown/40 hover:text-sage transition-colors duration-200 hidden sm:block"
              >
          ...
          <ProductGrid
            ...
            cols={collectionProducts.length > 2 ? 3 : 2}
            emptyMessage="No products in this collection yet. Check back soon."
          />
        </div>
      </section>

      {/* ── About the stone — cross-link to crystal guide ────────────────────── */}
      {crystal && (
              ...
              <ScrollReveal direction="right" className="flex flex-col gap-5">
                <div className="flex items-center gap-3">
                  <span
                    ...
                    aria-hidden="true"
                  />
                  <p className="font-sans text-[11px] tracking-[0.25em] uppercase text-gold/70">
                    The Stone
                  </p>
                </div>
                ...
                <p className="font-sans text-xs tracking-wider uppercase text-gold/70 font-medium">
                  {crystal.subtitle}
                </p>

                <blockquote className="gold-bar-left">
                  <p className="font-serif italic text-ivory/65 text-lg font-light leading-relaxed">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span key={prop}
                      className="font-sans text-[10px] tracking-wide text-ivory/60 border border-white/15 rounded-full px-3 py-1">
                      {prop}
                    </span>
                  ))}
                </div>
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 self-start font-sans text-sm text-gold hover:text-gold-light transition-colors duration-200 font-medium"
                >
        ...
        <section className="bg-ivory section-padding-sm border-t border-brown/10">
          <div className="container-luxury">
            <ScrollReveal>
              ...
              <h2
                className="font-serif font-light text-brown text-center mb-10"
              ...
              <StaggerReveal stagger={80}>
                {otherCollections.map((other) => (
                  <Link
                    ...
                    className="group relative overflow-hidden rounded-xl shadow-card hover:shadow-hover transition-shadow duration-400 block"
                    style={{ aspectRatio: "3/2" }}
                  >
                    <Image
                      src={other.heroImage}
                      alt={`${other.name} collection`}
                      fill
                      className="object-cover object-center transition-transform duration-600 ease-luxury group-hover:scale-105"
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4">
                      ...
                      <p className="font-serif font-light text-ivory text-base">
                        {other.name}
                      </p>
                    </div>
                  </Link>
