...
const PILLARS = [
  {
    ...
    description:
      "Every stone is 100% genuine — sourced ethically, never synthetic, never treated. You wear the real earth.",
  ...
  },
  {
    ...
    title: "Fast Gulf Shipping",
    description:
      "Quick, tracked delivery across Saudi Arabia, UAE, and Qatar. Your order arrives carefully packaged.",
  ...
  },
  {
    ...
    description:
      "Each piece is crafted by hand with precision and care — no mass production, no shortcuts.",
  ...
  },
  {
    ...
    description:
      "Order, ask questions, or track your delivery — all via WhatsApp. Real people, genuine care.",
    accent: "from-[#25D366]/15 to-[#25D366]/5",
    iconColor: "text-[#25D366]",
  },
];

export default function WhyAuraStor() {
  return (
    <section
      ...
      <div className="container-luxury">
        <ScrollReveal>
          <SectionTitle
            ...
            label="Our Promise"
            title="Why Aura Stor"
            subtitle="Every detail is considered — from the stone we source to the moment it arrives at your door."
            align="center"
            withDivider
          />
        </ScrollReveal>
